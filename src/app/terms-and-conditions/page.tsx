...
import { FileText } from "lucide-react"; // Using a document icon
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!pageContent || !pageContent.title) {
    return {
      title: "Fanskor Şartları ve Koşulları | Sports Data Hub",
      description:
        "Futbol veri platformumuzu kullanım haklarınızı, topluluk kurallarını ve politikalarını anlamak için Fanskor'un Şartlar ve Koşullarını okuyun.",
    };
  }
