    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        <form
          ...
          className="lg:col-span-2 bg-brand-secondary p-6 rounded-lg space-y-6"
        >
          <div>
            <label className="block text-sm font-medium text-brand-light mb-2 flex items-center gap-2">
            ...
            <input
              ...
              readOnly
              disabled
              className="w-full p-3 rounded bg-gray-700/50 text-brand-muted border border-gray-600 cursor-not-allowed"
            />
          </div>
