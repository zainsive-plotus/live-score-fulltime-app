...
import RichTextEditor from "@/components/admin/RichTextEditor"; // We'll reuse our existing editor
...
// Fetcher function for this page's content
...
export default function EditReportAbusePage() {
  ...
  // When data is fetched, populate the form fields
  useEffect(() => {
    if (data) {
      setTitle(data.title || "Report Abuse"); // Default title if empty
    ...
    <div>
      ...
      <div className="bg-brand-secondary p-6 rounded-lg space-y-6">
        ...
        <div>
          ...
          {/* We only render the editor once the initial content has been loaded */}
