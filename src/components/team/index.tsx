...
const TeamSquadWidget = dynamic(() => import("./TeamSquadWidget"));
const TeamFixturesWidget = dynamic(() => import("./TeamFixturesWidget"));
const LeagueStandingsWidget = dynamic(
  () => import("@/components/league-detail-view/LeagueStandingsWidget")
);
const TeamTransfersTab = dynamic(() => import("./TeamTransfersTab"));
const TeamHighlightsTab = dynamic(() => import("./TeamHighlightsTab"));
const TeamNewsTab = dynamic(() => import("./TeamNewsTab"));
